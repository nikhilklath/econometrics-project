...
set seed 123456
// same A, different H to begin with
// unequal productivity shocks (type b)
...
scalar a_a = a_a*(1+g+abs(rnormal(0.01,0.005)))
scalar a_b = a_b*(1+g+abs(rnormal(0.01,0.005))) 
...
save "C:\Users\nikhi\Desktop\BU_Sem_2\EC 508\Project\simdata_a_same_h_diff_diff_shock", replace