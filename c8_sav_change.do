...
* this do file is for the case where 
* states start with different A and H
* and initially poorer state increases its
* savings rate from year 21 onwards
...
if(`i'<=20){
	...
	scalar k_a = 1.5*s*Yt_a + (1-delta)*k_a
}
...
line net_mig year
line Y_a year || line Y_b year, yscale(log) ylabel(,angle(0))
line Y_pc_diff year || line w_diff year, ylabel(0(10)40)
line Yk_a year || line Yk_b year