...
use simdata_ah_diff_shock_ran_cons.dta
...
graph combine y_a3.gph y_b3.gph, row(1) title(`"A_A(0)<A_B(0), H_A(0)<H_B(0), ϵ_B=0.01, ϵ_A=abs(ϵ), ϵ~ N(0.01,0.005)"', size(medium))
graph save hist_y3.gph, replace
graph combine A_a3.gph A_b3.gph, row(1) title(`"A_A(0)<A_B(0), H_A(0)<H_B(0), ϵ_B=0.01, ϵ_A=abs(ϵ), ϵ~ N(0.01,0.005)"', size(medium))
...
graph combine y24.gph y_pc24.gph k_r24.gph l_r24.gph a_r24.gph, title(`"A_A(0)<A_B(0), H_A(0)<H_B(0), ϵ_B=0.01, ϵ_A=abs(ϵ), ϵ~ N(0.01,0.005)"', size(medium))
graph save hist_y3.gph, replace
