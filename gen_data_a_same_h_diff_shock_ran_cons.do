...
use simdata_a_same_h_diff_shock_ran_cons.dta
...
graph combine y_a.gph y_b.gph A_a.gph A_b.gph, title(`"A_A(0)=A_B(0), H_A(0)<H_B(0), ϵ_B=0.01, ϵ_A=abs(ϵ), ϵ~ N(0.01,0.005)"', size(medium))
...
forvalues i =12(12)50{
    clear all
    cd "C:\Users\nikhi\Desktop\BU_Sem_2\EC 508\Project\Data_a_same_h_diff_shock_ran_cons"
	use dataset`i'
	gen year =_n
